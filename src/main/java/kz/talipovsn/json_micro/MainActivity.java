    ...
    public void onClick(View view) {
        ...
        if (json != null) {
            ...
            try {
                ...
                textView.append("\n");
                textView.append("Загрязнённость: " + (polution1/24));
                textView.append("\n\n");
                textView.append("Дата: " + secondDay);
                textView.append("\n");
                textView.append("Загрязнённость: " + (polution2/24));
                textView.append("\n\n");
                textView.append("Дата: " + thirdDay);
                textView.append("\n");
                textView.append("Загрязнённость: " + (polution3/24));
                textView.append("\n\n");
                textView.append("Дата: " + fourthDay);
                textView.append("\n");
                textView.append("Загрязнённость: " + (polution4/24));
                textView.append("\n\n");
                textView.append("Дата: " + fifthDay);
                textView.append("\n");
                textView.append("Загрязнённость: ");
                textView.append("\n");
            } catch (Exception e) {
